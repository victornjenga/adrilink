...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full z-10 bg-gray-100 dark:bg-gray-950 ">
      <div className=" flex top-0 mt-0  text-center  h-[70px] items-center bg-gray-100 dark:bg-gray-950 z-10 w-full fixed justify-around  md:justify-around space-x-10">
        <div className="">
          <a href="/">
        ...
        <div className="hidden space-x-10  md:flex ">
          ...
          <h2 onClick={toggleSubmenu} className="menu-item sub__menus__arrows">
            ...
            <ul className={boxClassSubMenu.join(" ")}>
              <div className=" bg-gray-100 space-y-2 text-left flex flex-col pb-4  justify-center pl-4 my-2 dark:bg-black/60 dark:text-white ">
                <li>
          ...
          <Link href="/contact">
            <p className="text-xl hover:text-purple-600 cursor-pointer font-medium">
              Contact
            </p>
          </Link>
          <ThemeSwitch />
