  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className="text-4xl md:text-5xl py-5 text-transparent font-extrabold bg-clip-text bg-gradient-to-r from-red-600 to-red-900">
            David Kinyanjui
          </h1>
          <p className="justify-center">
            The entrepreneur who has used local artists to produce programmes
            that appeal to local audiences. Kinyanjui is associated with the
            production of reality TV shows, documentaries and advertisement for
            corporates
          </p>
          <div className="my-6 ">
            <a
              ...
              href="https://www.standardmedia.co.ke/amp/article/2000148104/from-rags-to-riches-the-tv-way"
            >
        ...
        <p className="italic md:hidden">
          (David Kinyanjui at his Sanaa Zote Production Ltd studios along Ngong
          road during an interview)
        </p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          />
          <p className="italic md:hidden">
            (David at his Sanaa Zote Production Ltd studios along Ngong road
            during an interview)
          </p>
        </motion.div>
